...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE]{Álgebra Linear e Geometria Analítica}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Álgebra Linear e Geometria Analítica\\\small{Um Livro Colaborativo}}
\date{\today}
\author{}
...
\begin{abstract}
  ...
  % Copiei do prefácio
  Este livro busca abordar os tópicos de um curso moderno de álgebra linear e geometria analítica em conjunto. Dá-se prioridade a uma abordagem intuitiva, com exemplos e exercícios que ilustrem os conceitos.
\end{abstract}
\fi
